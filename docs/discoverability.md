...
The site remains server-rendered Django. Its design, home template, hero, hiring copy, JavaScript and media assets are unchanged. The blog footer now links to the company page instead of linking back to itself.
...
- A browser workflow verifies the company page at desktop and mobile widths and retains screenshots for three days.
